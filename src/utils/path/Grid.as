package utils.path
{
	...
	public class Grid
	{
		...
		public function setEndNode2( gridId:int ):void
		{
			_endNode = _nodes[(gridId - 1) % BattleModel.numGrids][BattleModel.numGrids - 1 - int((gridId - 1) / BattleModel.numGrids)] as Node;
		}
		
		public function setStartNode2( gridId:int ):void
		{
			_startNode = _nodes[(gridId - 1) % BattleModel.numGrids][BattleModel.numGrids - 1 - int((gridId - 1) / BattleModel.numGrids)] as Node;
		}
