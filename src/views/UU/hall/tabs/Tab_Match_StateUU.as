package views.UU.hall.tabs 
{
	...
	//闯关模式
	public class Tab_Match_StateUU extends StateUU
	{
		...
		override public function onEnter():void 
		{
			...
			// Role.
			img = new BitmapLoaderUU;
			img.source = TResourceManager.getAsset("hall/img/match_role.png");
			...
			//模式描述
			dscLabel = TextUtil.createLabel5(HallConfig.MATCH_DSC_TEXT, 24, ColorUtil.WHITE, false,1,3.5,22,"黑体");
			dscLabel.width = 500;
			dscLabel.height = 200;
