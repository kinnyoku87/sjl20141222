package views.UU.comps.cardStates
{
	...
	public class SneakingCard_StateUU extends StateUU
	{
		...
		override public function onEnter():void 
		{
			...
			var name:String = "潜行者";
			var imageURL:String = "assets/temp/cards/qianxing.png";
			...
			// 上部外框.
			img = new BitmapLoaderUU;
			img.source = TResourceManager.getAsset("card/img/frame_upper_neutrality.png");
			this.fusion.addNode(img);
...
//			label.locatingOffsetX = 20;
			...
			// 魔耗數字.
			img = new BitmapLoaderUU;
			img.source = TResourceManager.getAsset(CardConfigurator.getMagicNumAssetId(0));
			this.fusion.addNode(img);
			img.x = 14;
			img.y = 2;
			...
			// 技能A描述
			label = TextUtil.createLabel4("敌人隐藏在浓雾中，看不清身影", 15, 0x0, ConfigTxt.CARD_DESC_WIDTH, ConfigTxt.CARD_DESC_HEIGHT);
			this.fusion.addNode(label);
			label.x = pos_A + 6;
			label.y = pos_B + 22;
		}
