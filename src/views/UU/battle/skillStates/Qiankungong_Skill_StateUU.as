...
public class Qiankungong_Skill_StateUU extends Abstract_Skill_StateUU {
	...
	override public function onEnter():void {
		...
		_arrow.play("common.eight", "atlas/skill/sheji", 0)
		_arrow.x = fromView.x;
		...
		// 射击音效.
		SfxManager.getInstance().loadAndPlay("assets/sounds/sfx/sheji.mp3");
	}
