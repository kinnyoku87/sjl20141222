...
public class Huolongdubiao_Skill_StateUU extends Abstract_Skill_StateUU {
	...
	override public function onEnter():void {
		...
		SfxManager.getInstance().loadAndPlay("assets/sounds/sfx/huolongdubiao.mp3");
		
		// 射出的箭.
		_arrow = new AnimatorUU;
		_arrow.play("common.eight", "atlas/skill/huolongdubiao", 0)
		_arrow.x = fromView.x;
