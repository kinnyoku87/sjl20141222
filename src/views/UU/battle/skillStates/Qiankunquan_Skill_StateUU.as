...
public class Qiankunquan_Skill_StateUU extends Abstract_Skill_StateUU {
	...
	override public function onEnter():void {
		...
		SfxManager.getInstance().loadAndPlay("assets/sounds/sfx/qiankunquan.mp3");
		
		_arrow = new AnimatorUU;
		_arrow.play("common.four", "atlas/skill/qiankunquan", 1, function():void {
			_arrow.play("common.qiankunquan", "atlas/skill/qiankunquan", 0)
		});
		
		_arrow.x = fromView.x;
		_arrow.y = fromView.y - 11;
		_arrow.pivotX = _arrow.sourceWidth / 2;
		_arrow.pivotY = _arrow.sourceHeight / 2 - 44;
