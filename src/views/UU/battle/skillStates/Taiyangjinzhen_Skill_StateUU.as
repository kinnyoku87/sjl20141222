...
public class Taiyangjinzhen_Skill_StateUU extends Abstract_Skill_StateUU {
	...
	override public function onEnter():void {
		...
		SfxManager.getInstance().loadAndPlay("assets/sounds/sfx/taiyangjinzhen.mp3");
		
		// 射出的箭.
		_arrow = new AnimatorUU;
		_arrow.play("common.four", "atlas/skill/taiyangjinzhen", 0)
		_arrow.x = fromView.x;
		_arrow.y = fromView.y - 15;
		_arrow.pivotX = _arrow.sourceWidth / 2;
		//_arrow.pivotY = _arrow.sourceHeight / 2 - 20;
		_arrow.pivotY = _arrow.sourceHeight / 2 + 30;
