...
public class Sanqianhuolongjun_Skill_StateUU  extends Abstract_Skill_StateUU {
	...
	private function onSkill1():void {
		...
		SfxManager.getInstance().loadAndPlay("assets/sounds/sfx/sanqianhuolongjun.mp3");
		
		gridIdList = MapModel.findPosList(this.fromView.vo.gridId, 1, 2, true);
		...
		while (i < l) {
			...
			anim_A.play("common.eight", "atlas/skill/sanqianhuolongjun_A", 1);
			...
			// 下层.
			anim_A = _animList[_numAnim++] = new AnimatorUU;
			anim_A.play("common.eight", "atlas/skill/sanqianhuolongjun_B", 1, i == 1 ? onSkill2 : null);
			this.stateActivePre.fusion.addNode(anim_A);
			anim_A.x = coord.x - anim_A.sourceWidth / 2;
			anim_A.y = coord.y - anim_A.sourceHeight / 2 - 48;
		}
	}
