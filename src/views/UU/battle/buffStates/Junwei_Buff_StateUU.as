package views.UU.battle.buffStates
{
	...
	public class Junwei_Buff_StateUU extends Abstract_Buff_StateUU
	{
		...
		override public function onEnter():void {
			...
			_animator.play("common.eight", "atlas/skill/junwei", 0);
