...
repeat:int -- 循环次数。设置为-1为无限循环 (第一次緩動不計入循環次數)
...
//---- GETTERS / SETTERS ----------------------------------------------------------------------------------------------------------
		 ...
		 **/
		public function get currentProgress():Number {return this.cachedTime / this.duration;}
		 ...
		 * time it takes the <code>totalProgress</code> property to go from 0 to 1 once.
		 **/
		public function get totalProgress():Number {return this.cachedTotalTime / this.totalDuration;}
		...
		public function get timeScale():Number {return this.cachedTimeScale;}
