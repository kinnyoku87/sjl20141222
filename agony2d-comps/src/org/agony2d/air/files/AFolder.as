...
public class AFolder extends AbstractFile {
	
	public function AFolder( file:File ) {//, baseFolderType:String, subPath:String ) {
		super(file)
...
//		m_subPath = subPath
	...
	public function createFile( fileName:String, extension:String ) : AFile {
		var file:File
		var proxy:AFile
