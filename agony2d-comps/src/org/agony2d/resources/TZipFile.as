package org.agony2d.resources {
	...
	import org.agony2d.zip.inside.ChecksumUtil;
	
	public class TZipFile {	
		
		public function TZipFile(filenameEncoding:String = "utf-8") {
		...
		internal function get hasDataDescriptor():Boolean {return _hasDataDescriptor;}
		...
		public function serialize(stream:IDataOutput, includeAdler32:Boolean, centralDir:Boolean = false, centralDirOffset:uint = 0):uint {
			...
			if(centralDir) {
				...
				stream.writeUnsignedInt(TZip.SIG_CENTRAL_FILE_HEADER);
				...
				stream.writeUnsignedInt(TZip.SIG_LOCAL_FILE_HEADER);
			}
		...
		protected var isCompressed:Boolean = false; // 是否為壓縮狀態.
		...
		//		public function get versionNumber():String {return _versionNumber;}
		//		public function get sizeCompressed():uint {return _sizeCompressed;}
		//		public function get sizeUncompressed():uint {return _sizeUncompressed;}
		
		public function get date():Date {return _date;}
		public function set date(value:Date):void {_date = (value != null) ? value : new Date();}
