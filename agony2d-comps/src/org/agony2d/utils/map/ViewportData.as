package org.agony2d.utils.map 
{
	...
	/** 视域数据
	 *  [◆]
	 * 		1. maxViewportX × maxViewportY
	 * 		2. contentX × contentY
	 * 		3. contentWidth × contentHeight
	 * 		4. viewportX × viewportY
	 * 		5. viewportWidth × viewportHeight
	 *  	6. ratioHoriz × ratioVerti
	 *  [◆◆]
	 *		1. motion
	 * 		2. motionTo
	 * 		3. seek
...
public class ViewportData
{
	...
	/** ◆视域的最大相对坐标 */
	public function get maxViewportX() : Number { return m_contentWidth  - m_viewportWidth  > 0 ? m_contentWidth  - m_viewportWidth  : 0 } 
	public function get maxViewportY() : Number { return m_contentHeight - m_viewportHeight > 0 ? m_contentHeight - m_viewportHeight : 0 } 
	...
	/** ◆视域的相对坐标 */
	public function get viewportX() : Number { return -m_contentX }
	public function get viewportY() : Number { return -m_contentY }
	...
	/** ◆水平比率 */
	public function get ratioHoriz() : Number { return MathUtil.getRatioBetween(m_contentX, this.maxHorizontal, 0) }
	public function set ratioHoriz( v:Number ) : void { }
	
	/** ◆垂直比率 **/
	public function get ratioVerti() : Number { return MathUtil.getRatioBetween(m_contentY, this.maxVertical, 0) }
	public function set ratioVerti( v:Number ) : void { }
	...
	/** 场景的最大坐标 */
	agony_internal function get maxHorizontal() : Number { return m_viewportWidth  - m_contentWidth  < 0 ? m_viewportWidth  - m_contentWidth  : 0 }
	agony_internal function get maxVertical()   : Number { return m_viewportHeight - m_contentHeight < 0 ? m_viewportHeight - m_contentHeight : 0 }
	
	agony_internal var m_viewportWidth:Number, m_viewportHeight:Number, m_contentX:Number, m_contentY:Number, m_contentWidth:Number, m_contentHeight:Number
}
}