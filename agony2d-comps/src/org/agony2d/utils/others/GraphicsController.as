...
final public class GraphicsController
{
	...
	agony_internal var m_bgColor:uint;
	
	agony_internal var m_bgAlpha:Number;
	
	agony_internal var m_lineColor:uint;
	
	agony_internal var m_lineAlpha:Number;
	
	agony_internal var m_thickness:Number;
	
	agony_internal var m_ellipse:int;
