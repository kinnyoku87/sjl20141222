package proto.com {
	...
	public dynamic final class OneItem extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ITEM_RES_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.com.OneItem.item_res_id", "itemResId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.com.OneItem.count", "count", (2 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (item_res_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneItem.itemResId cannot be set twice.');
					}
					++item_res_id$count;
				...
				case 2:
					if (count$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneItem.count cannot be set twice.');
					}
					++count$count;
