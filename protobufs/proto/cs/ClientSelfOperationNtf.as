package proto.cs {
	...
	public dynamic final class ClientSelfOperationNtf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CLIENT_MESSAGE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.ClientSelfOperationNtf.client_message", "clientMessage", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.cs.ClientMessage; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (client_message$count != 0) {
						throw new flash.errors.IOError('Bad data format: ClientSelfOperationNtf.clientMessage cannot be set twice.');
					}
