package proto.cs {
	...
	public dynamic final class SetCustomValueRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CUSTOM_VALUE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.SetCustomValueRes.custom_value", "customValue", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.CustomValue; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (custom_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: SetCustomValueRes.customValue cannot be set twice.');
					}
					++custom_value$count;
