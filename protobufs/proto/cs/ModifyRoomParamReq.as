package proto.cs {
	...
	public dynamic final class ModifyRoomParamReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ROOM_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.cs.ModifyRoomParamReq.room_name", "roomName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ROOM_PWD:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.cs.ModifyRoomParamReq.room_pwd", "roomPwd", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const OWNER_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.ModifyRoomParamReq.owner_id", "ownerId", (4 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (room_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ModifyRoomParamReq.roomName cannot be set twice.');
					}
					++room_name$count;
				...
				case 3:
					if (room_pwd$count != 0) {
						throw new flash.errors.IOError('Bad data format: ModifyRoomParamReq.roomPwd cannot be set twice.');
					}
					++room_pwd$count;
				...
				case 4:
					if (owner_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ModifyRoomParamReq.ownerId cannot be set twice.');
					}
					++owner_id$count;
