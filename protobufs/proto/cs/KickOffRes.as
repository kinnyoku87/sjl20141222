package proto.cs {
	...
	public dynamic final class KickOffRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const IS_KICK:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("proto.cs.KickOffRes.is_kick", "isKick", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (is_kick$count != 0) {
						throw new flash.errors.IOError('Bad data format: KickOffRes.isKick cannot be set twice.');
					}
					++is_kick$count;
