package proto.cs {
	...
	public dynamic final class AcceptFriendReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const IS_AGREE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.cs.AcceptFriendReq.is_agree", "isAgree", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const INVITE_ROLE_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.AcceptFriendReq.invite_role_id", "inviteRoleId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACCEPT_ROLE_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.AcceptFriendReq.accept_role_id", "acceptRoleId", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACCEPT_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("proto.cs.AcceptFriendReq.accept_name", "acceptName", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (is_agree$count != 0) {
						throw new flash.errors.IOError('Bad data format: AcceptFriendReq.isAgree cannot be set twice.');
					}
					++is_agree$count;
				...
				case 2:
					if (invite_role_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: AcceptFriendReq.inviteRoleId cannot be set twice.');
					}
				...
				case 3:
					if (accept_role_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: AcceptFriendReq.acceptRoleId cannot be set twice.');
					}
				...
				case 4:
					if (accept_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: AcceptFriendReq.acceptName cannot be set twice.');
					}
					++accept_name$count;
