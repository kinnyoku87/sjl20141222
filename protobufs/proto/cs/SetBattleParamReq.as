package proto.cs {
	...
	public dynamic final class SetBattleParamReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CAMP_BATTLE_CARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.SetBattleParamReq.camp_battle_card", "campBattleCard", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.CampBattleCard; });
		 ...
		 *  @private
		 */
		public static const IS_DELETE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("proto.cs.SetBattleParamReq.is_delete", "isDelete", (2 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (camp_battle_card$count != 0) {
						throw new flash.errors.IOError('Bad data format: SetBattleParamReq.campBattleCard cannot be set twice.');
					}
				...
				case 2:
					if (is_delete$count != 0) {
						throw new flash.errors.IOError('Bad data format: SetBattleParamReq.isDelete cannot be set twice.');
					}
					++is_delete$count;
