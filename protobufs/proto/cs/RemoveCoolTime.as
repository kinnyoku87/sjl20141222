package proto.cs {
	...
	public dynamic final class RemoveCoolTime extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const COOL_TIME:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.RemoveCoolTime.cool_time", "coolTime", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.CoolTime; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (cool_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: RemoveCoolTime.coolTime cannot be set twice.');
					}
					++cool_time$count;
