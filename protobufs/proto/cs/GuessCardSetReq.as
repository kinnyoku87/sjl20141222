package proto.cs {
	...
	public dynamic final class GuessCardSetReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CARD_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.GuessCardSetReq.card_id", "cardId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (card_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: GuessCardSetReq.cardId cannot be set twice.');
					}
					++card_id$count;
