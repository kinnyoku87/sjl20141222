package proto.cs {
	...
	public dynamic final class GetSimpleRoleReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.GetSimpleRoleReq.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REQUESTER_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.GetSimpleRoleReq.requester_id", "requesterId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: GetSimpleRoleReq.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (requester_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: GetSimpleRoleReq.requesterId cannot be set twice.');
					}
					++requester_id$count;
