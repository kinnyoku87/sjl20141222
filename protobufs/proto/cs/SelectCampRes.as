package proto.cs {
	...
	public dynamic final class SelectCampRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CAMP_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.SelectCampRes.camp_id", "campId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BAG_INDEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.SelectCampRes.bag_index", "bagIndex", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USE_BAG_CARD:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("proto.cs.SelectCampRes.use_bag_card", "useBagCard", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (camp_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: SelectCampRes.campId cannot be set twice.');
					}
					++camp_id$count;
				...
				case 2:
					if (bag_index$count != 0) {
						throw new flash.errors.IOError('Bad data format: SelectCampRes.bagIndex cannot be set twice.');
					}
					++bag_index$count;
				...
				case 3:
					if (use_bag_card$count != 0) {
						throw new flash.errors.IOError('Bad data format: SelectCampRes.useBagCard cannot be set twice.');
					}
					++use_bag_card$count;
