package proto.cs {
	...
	public dynamic final class EnterArenaNtf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const GAME_TIME_TICK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("proto.cs.EnterArenaNtf.game_time_tick", "gameTimeTick", (3 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					if (game_time_tick$count != 0) {
						throw new flash.errors.IOError('Bad data format: EnterArenaNtf.gameTimeTick cannot be set twice.');
					}
