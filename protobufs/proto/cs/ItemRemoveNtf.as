package proto.cs {
	...
	public dynamic final class ItemRemoveNtf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ITEM_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.ItemRemoveNtf.item_id", "itemId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ITEM_COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.ItemRemoveNtf.item_count", "itemCount", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (item_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ItemRemoveNtf.itemId cannot be set twice.');
					}
					++item_id$count;
				...
				case 2:
					if (item_count$count != 0) {
						throw new flash.errors.IOError('Bad data format: ItemRemoveNtf.itemCount cannot be set twice.');
					}
					++item_count$count;
