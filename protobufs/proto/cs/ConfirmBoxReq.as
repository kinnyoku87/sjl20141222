package proto.cs {
	...
	public dynamic final class ConfirmBoxReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const BOX_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.ConfirmBoxReq.box_id", "boxId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (box_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ConfirmBoxReq.boxId cannot be set twice.');
					}
					++box_id$count;
