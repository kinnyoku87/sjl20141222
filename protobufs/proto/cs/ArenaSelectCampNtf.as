package proto.cs {
	...
	public dynamic final class ArenaSelectCampNtf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ROLE_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.ArenaSelectCampNtf.role_id", "roleId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CAMP_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.ArenaSelectCampNtf.camp_id", "campId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (role_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ArenaSelectCampNtf.roleId cannot be set twice.');
					}
					++role_id$count;
				...
				case 2:
					if (camp_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ArenaSelectCampNtf.campId cannot be set twice.');
					}
					++camp_id$count;
