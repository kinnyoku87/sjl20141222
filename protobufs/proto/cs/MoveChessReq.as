package proto.cs {
	...
	public dynamic final class MoveChessReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CHESS_UID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.MoveChessReq.chess_uid", "chessUid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MOVE_PATH:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.cs.MoveChessReq.move_path", "movePath", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.cs.ChessPos; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (chess_uid$count != 0) {
						throw new flash.errors.IOError('Bad data format: MoveChessReq.chessUid cannot be set twice.');
					}
					++chess_uid$count;
