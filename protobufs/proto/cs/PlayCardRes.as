package proto.cs {
	...
	public dynamic final class PlayCardRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CARD_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.PlayCardRes.card_id", "cardId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COST_MP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.PlayCardRes.cost_mp", "costMp", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LAST_MP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.PlayCardRes.last_mp", "lastMp", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CHESS_POS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.PlayCardRes.chess_pos", "chessPos", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.cs.ChessPos; });
		 ...
		 *  @private
		 */
		public static const SKILL_USE_REQ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.PlayCardRes.skill_use_req", "skillUseReq", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.cs.SkillUseReq; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (card_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayCardRes.cardId cannot be set twice.');
					}
					++card_id$count;
				...
				case 2:
					if (cost_mp$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayCardRes.costMp cannot be set twice.');
					}
					++cost_mp$count;
				...
				case 3:
					if (last_mp$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayCardRes.lastMp cannot be set twice.');
					}
					++last_mp$count;
				...
				case 4:
					if (chess_pos$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayCardRes.chessPos cannot be set twice.');
					}
					++chess_pos$count;
				...
				case 5:
					if (skill_use_req$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayCardRes.skillUseReq cannot be set twice.');
					}
					++skill_use_req$count;
