package proto.cs {
	...
	public dynamic final class GetRoleRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ROLE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("proto.cs.GetRoleRes.role_info", "roleInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.RoleInfo; });
		 ...
		 *  @private
		 */
		public static const CAMP_LEVELS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.cs.GetRoleRes.camp_levels", "campLevels", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.CampLevel; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (role_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: GetRoleRes.roleInfo cannot be set twice.');
					}
					++role_info$count;
