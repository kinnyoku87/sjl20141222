package proto.cs {
	...
	public dynamic final class MysticalBoxOpenReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SHOP_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.MysticalBoxOpenReq.shop_id", "shopId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BUY_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.MysticalBoxOpenReq.buy_type", "buyType", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (shop_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MysticalBoxOpenReq.shopId cannot be set twice.');
					}
					++shop_id$count;
				...
				case 2:
					if (buy_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: MysticalBoxOpenReq.buyType cannot be set twice.');
					}
					++buy_type$count;
