package proto.cs {
	...
	public dynamic final class KickRoomNtf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const KICKEDER_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.KickRoomNtf.kickeder_id", "kickederId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (kickeder_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: KickRoomNtf.kickederId cannot be set twice.');
					}
					++kickeder_id$count;
