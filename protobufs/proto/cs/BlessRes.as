package proto.cs {
	...
	public dynamic final class BlessRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const FRIEND_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("proto.cs.BlessRes.friend_id", "friendId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const EXP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("proto.cs.BlessRes.exp", "exp", (2 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (friend_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: BlessRes.friendId cannot be set twice.');
					}
					++friend_id$count;
				...
				case 2:
					if (exp$count != 0) {
						throw new flash.errors.IOError('Bad data format: BlessRes.exp cannot be set twice.');
					}
					++exp$count;
