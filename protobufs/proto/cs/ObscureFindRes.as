package proto.cs {
	...
	public dynamic final class ObscureFindRes extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ROLE_LIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.cs.ObscureFindRes.role_list", "roleList", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.com.List_Unit; });
